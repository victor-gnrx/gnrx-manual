---
description: >-
  Como a API de Integração GNRx versiona mudanças, mantendo todas as versões
  publicadas disponíveis
icon: code-compare
layout:
  width: default
  title:
...
* O lançamento de uma nova versão é anunciado por e-mail aos responsáveis técnicos cadastrados de cada API Key, além de publicado no changelog (ver [Changelog](versionamento.md#changelog)).
